...
def DouyinCrawler(url):
    # for page in range(1):
    # url='https://www.douyin.com/aweme/v1/web/comment/list/?device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=7083310228367887647&cursor=0&count=20&item_type=0&rcFT=&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=99.0.4844.51&browser_online=true&engine_name=Blink&engine_version=99.0.4844.51&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7082249047388145183&msToken=eN4G2Ag_h_QAhirc8fybNKextgoRnbEVw2IMsJ9TK2zbsVSqt6EgndL2m2hSTRJhkq-1yObcItwMQk-b2cC8xuzJGnYmlVFFoR7EeRbuDYCNILWQmQ_CbugITJFmSQtcZA==&X-Bogus=DFSzswVuXR0ANcPHSlofXsUClL9I&_signature=_02B4Z6wo00001R0uAQgAAIDANqRazwOlAQkdLgWAACUJdvCSMvPPjPgpcUYlNSXwkXFGW2j8MA852UNfnzyfOtbAlJeCVhEp5ZHHBsWpXhx.ORNCFItWVBjOG4q0r0hlD6By-UpGZRLFritZf2'
    html=require(url)
    Html(html)
    print(com)
    save_afile(com,"DouyinComment")
